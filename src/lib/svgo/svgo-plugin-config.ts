export type SvgoPluginDefinition = {
  id: string
  name: string
  enabledByDefault: boolean
}

export const svgoPluginConfig = [
  ...
  { id: "sortAttrs", name: "Sort attrs", enabledByDefault: false },
  {
    id: "sortDefsChildren",
    name: "Sort children of <defs>",
    enabledByDefault: true,
  },
  { id: "removeTitle", name: "Remove <title>", enabledByDefault: true },
  ...
  },
  {
    ...
    name: "Convert one-stop gradients to solid colours",
    enabledByDefault: false,
  },
  {
  ...
  {
    id: "removeXlink",
    name: "Replace xlink with native SVG",
    enabledByDefault: false,
  },
] as const satisfies readonly SvgoPluginDefinition[]

export type SvgoPluginId = (typeof svgoPluginConfig)[number]["id"]
